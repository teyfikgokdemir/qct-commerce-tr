...
const seo: Record<SeoPage, SeoEntry> = {
  ...
  'e-commerce': { title: 'B2B E-Ticaret Çözümleri — QCT Commerce', description: 'Üretici, toptancı, ihracatçı ve büyüyen markalar için SEO, GEO, AEO, AIO ve dönüşüm odaklı B2B e-ticaret altyapıları kuruyoruz.' },
  ...
  'seo-performance': { title: 'SEO, GEO, AEO ve AIO Hizmetleri — QCT Commerce', description: 'Üretici, ihracatçı, e-ticaret markası ve KOBİ’lerin Google ve yapay zekâ sistemlerinde doğru bağlamla bulunmasını sağlayan görünürlük altyapısı.' },
