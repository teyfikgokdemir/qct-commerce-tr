...
const seo: Record<SeoPage, SeoEntry> = {
  ...
  'website-design': { title: 'Web Sitesi Yaptırma & Web Tasarım Fiyatları | QCT Commerce', description: 'Kurumsal, kişisel ve hizmet sitesi yaptırmak isteyenler için mobil uyumlu web tasarım, site yenileme ve şeffaf başlangıç fiyatları. 6.900 TL’den başlayan seçenekleri inceleyin.' },
